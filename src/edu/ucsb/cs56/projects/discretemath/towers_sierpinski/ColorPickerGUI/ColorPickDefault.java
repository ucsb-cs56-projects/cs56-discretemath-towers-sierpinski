...
public class ColorPickDefault {
    ...
    */
	...
	open = true;
	//TITLE
        banner = new JLabel("<html>Choose a Color Scheme in the drop down menu.<br>You can preview the scheme or save your choice.</html>",JLabel.CENTER);
        banner.setForeground(Color.black);
        banner.setBackground(Color.white);
        banner.setOpaque(true);
        banner.setFont(new Font("Courier New", Font.BOLD, 18));
		
	//Switch to system design scheme
	...
	JButton CustomButton = new JButton("Create New Scheme");
